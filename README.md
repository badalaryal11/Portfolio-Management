This project is a protfolio management system in which users is able to list the availabile stocks along with transaction date, status (Buy/Sell), quantity,amount.
